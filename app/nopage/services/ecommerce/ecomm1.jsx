            ...
            <div className="relative z-10 mb-10 bg-white text-black px-4 lg:px-0 py-6 lg:pt-8 flex justify-center">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <span className='mr-1'>🚀 Launch Your <br className="lg:hidden block" /> <span className='bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'>E-Commerce</span> </span>
                            <br className="hidden lg:block" />
                            Store In <br className="lg:hidden block" /> Just ⏱️
                            <motion.span
                                initial={{ scale: 0.9 }}
                                animate={{ scale: 1 }}
                        ...
                        >
                            Stop losing sales to clunky stores. We build lightning-fast, mobile-optimized e-commerce sites that boost conversions and drive growth.
                        </motion.p>
                        ...
                        >
                            {[
                                    ...
                                    ["✓", "Built for Sales", "Optimized checkout & product pages"],
                                    ["✓", "Free Lifetime Support", "Never pay for fixes or tweaks"],
                                    ["✓", "SEO-Optimized", "Rank higher, drive organic traffic"],
                                    ["✓", "No Upfront Payment", "Pay only after store launch"]
                        ...
                        >
                            <p className="italic text-sm lg:text-base">"We started getting orders within 3 days of launch. Best decision ever!"</p>
                            <p className="font-medium mt-1 lg:mt-2 text-sm">- Chitrangdaa shany , Owner</p>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="flex flex-col gap-4 lg:gap-6 w-full lg:w-1/3">
                        ...
                        >
                            <span className="relative z-10">🎁 Fill the form and receive free e-commerce design templates </span>
                        ...
                        >
                            ...
                            <h2 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 text-center">
                                Launch Your Store Risk-Free Today ✨<span className="text-blue-600">✨</span>
