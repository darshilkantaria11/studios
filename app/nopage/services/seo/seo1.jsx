                    ...
                    <div className="flex flex-col gap-4 lg:gap-6 w-full lg:w-1/3">
                        ...
                        >
                            <span className="relative z-10">
                                📝 Fill the form to get your FREE Website SEO Report
                            </span>
                        ...
                        >
                            ...
                            <h2 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 text-center">
                                Rank Higher, Faster <span className="text-blue-600">⚡</span>
                                <p className="text-sm text-gray-600 mt-2">Helping Brands Grow Online, Every Day</p>
                            </h2>
                            ...
                            <div className="space-y-3">
                                ...
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    href="/form-page"
                                    className="w-full bg-gradient-to-r from-blue-600 to-green-500 text-white font-semibold py-3 rounded-lg transition-all duration-300 flex justify-center items-center gap-2 relative overflow-hidden"
                                >
                                    <span className="relative z-10">
